...
- Name: conduit-flows.spec.ts >> Conduit User Journeys >> API Contract Validation >> CORS headers are present for API endpoints
- Location: e2e/playwright/specs/conduit-flows.spec.ts:114:9
