...
- Name: conduit-flows.spec.ts >> Conduit User Journeys >> API Contract Validation >> Content-Type headers are correct
- Location: e2e/playwright/specs/conduit-flows.spec.ts:93:9

# Error details

```
TypeError: (0 , _test.expect)(...).some is not a function
```
